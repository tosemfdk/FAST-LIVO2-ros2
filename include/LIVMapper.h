...
public:
  ...
  void standard_pcl_cbk(PointCloud2ConstPtr msg);
  void livox_pcl_cbk(LivoxCustomConstPtr msg_in);
  void imu_cbk(ImuConstPtr msg_in);
  void img_cbk(ImageConstPtr msg_in);
  void publish_img_rgb(VIOManagerPtr vio_manager);
  void publish_frame_world(VIOManagerPtr vio_manager);
  void publish_accumulated_map(const PointCloudXYZRGB::Ptr &rgb_cloud, const PointCloudXYZI::Ptr &intensity_cloud);
  ...
  cv::Mat getImageFromMsg(ImageConstPtr img_msg);
  ...
  int map_pub_interval = 5;
  int map_pub_count = 0;
  int map_pub_max_points = 500000;
  double map_pub_voxel_size = 0.20;
  ...
  PointCloudXYZRGB::Ptr accumulated_map_rgb;
  PointCloudXYZI::Ptr accumulated_map_intensity;
  ...
  rclcpp::Subscription<PointCloud2Msg>::SharedPtr sub_pcl_standard;
  rclcpp::Subscription<LivoxCustomMsg>::SharedPtr sub_pcl_livox;
  rclcpp::Subscription<ImuMsg>::SharedPtr sub_imu;
  rclcpp::Subscription<ImageMsg>::SharedPtr sub_img;
  rclcpp::Publisher<PointCloud2Msg>::SharedPtr pubLaserCloudFullRes;
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pubNormal;
  rclcpp::Publisher<PointCloud2Msg>::SharedPtr pubSubVisualMap;
  rclcpp::Publisher<PointCloud2Msg>::SharedPtr pubLaserCloudEffect;
  rclcpp::Publisher<PointCloud2Msg>::SharedPtr pubLaserCloudMap;
  rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr pubOdomAftMapped;
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pubPath;
  rclcpp::Publisher<PointCloud2Msg>::SharedPtr pubLaserCloudDyn;
  rclcpp::Publisher<PointCloud2Msg>::SharedPtr pubLaserCloudDynRmed;
  rclcpp::Publisher<PointCloud2Msg>::SharedPtr pubLaserCloudDynDbg;
  rclcpp::Publisher<ImageMsg>::SharedPtr pubImage;
