...
void Preprocess::process(const LivoxCustomConstPtr &msg, PointCloudXYZI::Ptr &pcl_out)
{
  avia_handler(msg);
  *pcl_out = pl_surf;
}

void Preprocess::process(const PointCloud2ConstPtr &msg, PointCloudXYZI::Ptr &pcl_out)
{
  switch (lidar_type)
  {
  case OUST64:
...
void Preprocess::avia_handler(const LivoxCustomConstPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::l515_handler(const PointCloud2ConstPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::oust64_handler(const PointCloud2ConstPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::velodyne_handler(const PointCloud2ConstPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::Pandar128_handler(const PointCloud2ConstPtr &msg)
{
  pl_surf.clear();
...
void Preprocess::xt32_handler(const PointCloud2ConstPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::robosense_handler(const PointCloud2ConstPtr &msg)
{
  pl_surf.clear();
